...
document.write(`<p style="color: #bdb76b;">Зобразити рівнобедрений трикутник із символів ^. Висоту задає користувач. Наприклад, на екрані висота = 5</p>`)
...
document.write(`<pre style="margin: 10px; font-size: 1.6em;">${output}</pre>`)
...
document.write(`<span style="color: #bdb76b;">Завдання з файлу ДЗ_Копія Додаткові_цикли While_DoWhile. <br>розділ_ІНШІ: TASK_21</span>`)
document.write(`<p style="color: #bdb76b;">Напишіть програму для переводу мір довжини, торгової та аптекарської ваги (лічильник циклу від 1 до 10)<br>Список значень:

<ul>
    <li> сажнів у метри (1 сажень дорівнює 2,1366 м) </li>   
    <li> дюймів у сантиметри (1 дюйм дорівнює 2,5 см) </li>
    <li> футів у метри (1 фут дорівнює 0,3048 м) </li>
    <li> драхм у грами (1 драхма дорівнює 3,7325 г) </li>    
    <li> унцій у грами (1 унція дорівнює 29,86 г) </li>    
    <li> фунтів у кілограми (1 фунт дорівнює 0,40951 кг) </li>
    <li> аршинів у метри (1 аршин дорівнює 0,7112 м) </li>
    <li> золотників у грами (1 золотник дорівнює 4,2657 г) </li>
    <li> дюймів у міліметри (1 дюйм дорівнює 25,3995 мм) </li>
</ul>
</p>`)

document.write(`<p style="color: #bdb76b;">while</p>`)
