...
document.write(`
  <p style="color: #d8d38d;">Task_01<br>З клавіатури вводяться імена двох дітей та кількість у них цукерок. 
  Вивести не екран ім’я тієї дитини, у якої кількість цукерок є більшою, або вивести, що кількість однакова</p>`)
...
document.write(`<p style="color: #d8d38d;">Task_02<br>З клавіатури вводиться ціна 
  товару і кількість грошей. Якщо грошей не вистачає то відмовляємо у покупці, 
...
if (clientMoney < productPrice){
  ...
  document.write(`Недостатньо коштів. Ще потрібно: ${moneyRequired.toFixed(2)} грн`)
} else{
...
document.write(`<p style="color: #d8d38d;">Task_03<br>Випадковим чином генерується число від 1 до 5.
  Спробуйте вгадати число за 2 спроби</p>`)
...
document.write(`
  <p style="color: #d8d38d;">Task_04<br>З клавіатури вводиться вік людини. Вивести на екран ким він є 
  (дитиною у садочку, школярем, студентом, працівником, пенсіонером)</p>`)
...
if (userInput === null || userInput === ''|| isNaN (parseInt(userInput)) )
  ...
  result = 'Incorrect number. Enter the number from 2 to 120'
  else if (userAge < 7) 
...
document.write(`<p style="color: #d8d38d;">Task_05<br>З клавіатури вводиться назва категорії водія 
...
document.write(`
  <p style="color: #d8d38d;">Task_06<br>З клавіатури вводиться номер дня тижня.
  Вивести на екран назву дня</p>`)
...
document.write(`<p style="color: #d8d38d;">Task_07<br>З клавіатури вводиться номер місяця.
  Вивести до якої пори він відноситься</p>`)
