...
if (confirm('Task_01_ALLOW?')) {
    ...
    console.log(`Task_01_ ${nameChild}`);
}
...
if (confirm('Task_05_ALLOW?')) {
    ...
    console.log(`Task_05_ VehType: ${vehType}`);
}
...
if (confirm('Task_07_if else_ALLOW?')) {
    ...
    console.log(`Task_07_ Місяць ${numMonth} — пора року: ${season}`);
...
if (confirm('Task_07_switch(true)_ALLOW?')) {
    ...
    console.log(`Task_07_ Month ${monthNum} - Time of year: ${seasonYear}`);
